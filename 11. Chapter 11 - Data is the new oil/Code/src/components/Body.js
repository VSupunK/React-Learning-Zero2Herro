...
const Body = () => {
  ...
  if (onlineStatus === false)
    return (
      <h1>Looks like you're offline! Please check your online connection.</h1>
    );
    ...
    <div className="body">
      <div className="filter flex items-center">
        <div className="search m-2 p-4">
          ...
          />
          <button
            className="ml-5 px-4 hover:bg-gray-400 rounded-md bg-blue-400 hover:text-white"
        ...
        <div className="m-2 p-4">
          <button
            className="px-4 hover:bg-gray-400 rounded-md bg-green-500 hover:text-white"
            onClick={() => {
